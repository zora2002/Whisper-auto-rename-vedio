...
**Reason**: 原本限制特定命名格式（標準格式、Screen Recording），導致一般命名的影片無法進入流程
**Migration**: 改用新的「掃描目錄中所有 MP4 檔案」requirement，接受所有 `.mp4`
...
#### Scenario: Screen Recording 格式也被回傳
- **WHEN** 目錄中有 `Screen_Recording_20250719_070442.mp4`
- **THEN** 回傳 `["Screen_Recording_20250719_070442.mp4"]`
